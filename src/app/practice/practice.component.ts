...
//       iterms.push(...flattenArray(arr[index]));
//       console.log('iterms', iterms);
//       console.log('flattenArray', ...flattenArray(arr[index]));
//     } else {
//       iterms.push(arr[index]);
//     }
//   }
//   return iterms;
// }
...
// console.log('flatArray', flatArray); // Output: [1, 2, 3, 4, 5, 6, 7]